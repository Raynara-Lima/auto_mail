    ...
    class TelaPrincipal extends Component {
        ...
        <Row style={{paddingTop: '70px', boxShadow: "2px 2px 12px #a9a6a6", width: "80%", height: "125px", padding: "30px", backgroundColor: "#fcfcfc", borderWidth: "2px",marginTop: "43px", border: '1px solid #b5abab',
    marginLeft: '127px'}}>
            <Col md={12}>
            <Col md={3}>
            ...
            <Col md={3} style={{    paddingTop: '24px', paddingLeft: '70px'}}>
            <Button>Modo Expresso</Button>
